...
const gameOver = () => {
  ...
  const roundTakenTime = parseInt(timeTaken);
  ...
  resultModal.innerHTML += `
    <h1>Finished!</h1>
    <p>You took: <span class="bold">${roundTakenTime}</span> seconds</p>
    <p>You made <span class="bold red">${errorCount}</span> mistakes</p>
    <button onclick="closeModal()">Close</button>
  `;

  addHistory(questionText, roundTakenTime, errorCount);
